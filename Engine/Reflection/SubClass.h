...
template <typename T> 
struct SubClassTypeTrait<const SubClass<T>>
{ 
	enum { Value = true }; 
};
template <typename T> 
struct SubClassTypeTrait<volatile SubClass<T>>
{ 
	enum { Value = true }; 
};
template <typename T> 
struct SubClassTypeTrait<const volatile SubClass<T>>
{ 
	enum { Value = true };
};

template<typename T>
constexpr bool IsSubClassType = SubClassTypeTrait<T>::Value;
